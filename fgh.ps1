...
Write-Host "     curl -Method POST -Uri http://data-api.local/ingest -ContentType 'application/json' -Body '{`"source`":`"test`",`"metrics`":{`"value`":123}}'" -ForegroundColor Gray
Write-Host "     curl http://data-api.local/data" -ForegroundColor Gray
Write-Host ""
